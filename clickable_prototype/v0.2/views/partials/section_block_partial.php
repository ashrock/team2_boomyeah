<div id="section_<?= $id ?>" class="section_block">
    ...
    <div class="section_controls">
        ...
        <ul id="section_more_actions_<?= $id ?>" class="dropdown-content more_action_list">
            <li class="edit_title_btn"><a href="#!" data-section_id="<?= $id ?>" class="edit_title_icon">Edit Title</a></li>
            <li class="divider" tabindex="-1"></li>
            <li><a href="#!" data-section_id="<?= $id ?>" class="duplicate_icon">Duplicate</a></li>
            <li class="divider" tabindex="-1"></li>
            <li><a href="#confirm_to_remove" class="remove_icon modal-trigger remove_btn" data-section_id="<?= $id ?>" data-documentation_action="remove">Remove</a></li>
        </ul>
    </div>
</div>