        ...
        <div id="section_<?= $section['id'] ?>" class="section_block" tabindex="2">
            <?php if($_SESSION["user_level_id"] == USER_LEVEL["ADMIN"]) { ?>    
                ...
                <ul id="section_more_actions_<?= $section['id'] ?>" class="more_action_list">
                    <li class="edit_title_btn"><a href="#!" tabindex="2" data-section_id="<?= $section['id'] ?>" class="section_block_icon edit_title_icon"></a></li>
                    <li><a href="#!" tabindex="2" data-section_id="<?= $section['id'] ?>" class="section_block_icon duplicate_icon"></a></li>
                    <li><a href="#confirm_to_remove" tabindex="2" class="section_block_icon remove_icon modal-trigger remove_btn" data-section_id="<?= $section['id'] ?>" data-section_title="<?= $section['title'] ?>"  data-documentation_action="remove"></a></li>
                </ul>
            <?php } else { ?> 
