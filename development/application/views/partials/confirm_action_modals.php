<div id="confirm_remove_comment" class="confirm_action_modal">
    <div id="confirm_remove_comment_modal" class="modal confirmation_modal">
        <form action="/posts/remove" method="POST" id="remove_comment_form">
            ...
            <div class="modal-content">
                ...
                <h4>Are you sure?</h4>
                <p>Do you really want to remove this comment? This action cannot be undone.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="modal-close waves-effect btn-flat no_btn">Cancel</button>
                <button type="submit" class="modal-close waves-effect btn-flat yes_btn">Yes, Remove</button>
            </div>
        </form>
    </div>
</div>
<div id="confirm_remove_tab" class="confirm_action_modal">
    <div id="confirm_remove_tab_modal" class="modal confirmation_modal">
        <form action="/modules/remove_tab" method="POST" id="remove_tab_form">
            ...
            <div class="modal-content">
                <div class="confirmation_modal_icon"></div>
                <h4>Are you sure?</h4>
                <p>Do you really want to remove `<span class="tab_title"></span>` tab? This action cannot be undone.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="modal-close waves-effect btn-flat no_btn">Cancel</button>
                <button type="submit" class="modal-close waves-effect btn-flat yes_btn">Yes, Remove</button>
...
<div id="confirm_remove_uploaded_file" class="confirm_action_modal">
    <div id="confirm_remove_uploaded_file_modal" class="modal confirmation_modal">
...
<div id="error_uploaded_file" class="confirm_action_modal">
    <div id="error_uploaded_file_modal" class="modal confirmation_modal">
        <div class="modal-content">
